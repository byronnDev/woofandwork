#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/home/mikel/.vscode/extensions/wallabyjs.console-ninja-1.0.373/out/buildHook/index.js').default({tool: 'astro', checkSum: '20a0b41cc75a41a9e713a9VB5SGgRZUVNRUgxUBVgBVAAEBw9T', mode: 'build'}); } catch(cjsError) { try { import('file:///home/mikel/.vscode/extensions/wallabyjs.console-ninja-1.0.373/out/buildHook/index.js').then(m => m.default.default({tool: 'astro', checkSum: '20a0b41cc75a41a9e713a9VB5SGgRZUVNRUgxUBVgBVAAEBw9T', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
